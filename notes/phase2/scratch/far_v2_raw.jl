...
# NMAX is the FLOOR of the table's k-series order, not a cap: farSet raises it to whatever the
...
function farSet(sQ::NTuple{3,QI}, frq::Complex{T}; tol::Float64 = TOL,
    ...
    # The k-series order the table must carry is NOT a compile-time constant: bslTal grows as
